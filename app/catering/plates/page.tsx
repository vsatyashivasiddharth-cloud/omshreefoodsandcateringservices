...
export const metadata: Metadata = {
  ...
  description:
    "Explore vegetarian and non-vegetarian catering plate packages from Om Shree Foods & Caterers.",
  alternates: {
              ...
              {options.map((option) => {
                ...
                return (
                  <Link
                    key={option.title}
                    href={option.href}
                    className="group rounded-[32px] border border-[#EFD8AE] bg-white p-8 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl sm:p-10"
                  >
