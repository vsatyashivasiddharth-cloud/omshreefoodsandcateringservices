...
export default function ImageUploader({
  ...
  return (
    <div className="space-y-5">
      {value && (
        <div className="overflow-hidden rounded-2xl border border-[#F3DFC2] bg-white">
          <div className="flex items-center justify-between gap-4 border-b border-[#F3DFC2] bg-green-50 px-4 py-4 sm:px-5">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-sm text-green-700">
                  This image will be saved with your item.
                </p>
              </div>
            </div>
          ...
          <div className="p-4 sm:p-5">
            <div className="relative h-56 w-full overflow-hidden rounded-2xl border border-[#F3DFC2] bg-[#FFFDF8]">
              {previewError ? (
                <div className="flex h-full flex-col items-center justify-center px-6 text-center">
                  ...
                  <p className="mt-3 font-semibold text-[#6D2E00]">
                    Preview unavailable
                  </p>

                  <p className="mt-1 text-sm text-gray-500">
                    The uploaded URL will still be saved.
                  </p>
                </div>
              ) : (
                <Image
      ...
      >
        ...
        <p className="mt-2 max-w-sm text-sm leading-6 text-gray-500">
          Choose a JPG, PNG or WebP image from your device. The maximum
          supported file size is 5 MB.
        </p>
