...
const features = [
  {
    ...
    description:
      "Homemade recipes prepared with carefully selected premium ingredients.",
    icon: Utensils,
  },
  {
    title: "Reliable Delivery",
    description:
      "Fresh food packed carefully and delivered on time.",
    icon: Truck,
  },
  {
    title: "Trusted Catering",
    description:
      "Authentic flavours and dependable service for memorable celebrations.",
    icon: BadgeCheck,
  },
];
...
export default function ContactCTA() {
  return (
    <section className="relative overflow-hidden bg-[#FFFDF8] py-20 sm:py-24">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -left-24 top-0 h-80 w-80 rounded-full bg-[#FFF4DE]/70 blur-3xl"
      />
          ...
          <div className="relative p-8 sm:p-10 md:p-14 lg:p-16">
            ...
            <div className="relative">
              ...
              <p className="mt-7 max-w-3xl text-base leading-8 text-white/90 sm:text-lg sm:leading-9">
                Whether you are craving authentic homemade snacks or planning
                a memorable celebration, we are here to provide exceptional
                food, dependable service and a wonderful experience from start
                to finish.
              </p>
